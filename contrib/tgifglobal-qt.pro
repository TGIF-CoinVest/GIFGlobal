...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/tgifglobal-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/tgifglobal-cli.cpp \
           src/tgifglobal-tx.cpp \
           src/tgifglobal.cpp \
           src/db.cpp \
           ...
           src/qt/tgifglobal.cpp \
           src/qt/tgifglobalstrings.cpp \
...
RESOURCES += src/qt/tgifglobal.qrc src/qt/tgifglobal_locale.qrc

TRANSLATIONS += src/qt/locale/tgifglobal_bg.ts \
                src/qt/locale/tgifglobal_de.ts \
                src/qt/locale/tgifglobal_en.ts \
                src/qt/locale/tgifglobal_es.ts \
                src/qt/locale/tgifglobal_fi.ts \
                src/qt/locale/tgifglobal_fr.ts \
                src/qt/locale/tgifglobal_it.ts \
                src/qt/locale/tgifglobal_ja.ts \
                src/qt/locale/tgifglobal_pl.ts \
                src/qt/locale/tgifglobal_pt.ts \
                src/qt/locale/tgifglobal_ru.ts \
                src/qt/locale/tgifglobal_sk.ts \
                src/qt/locale/tgifglobal_sv.ts \
                src/qt/locale/tgifglobal_vi.ts \
                src/qt/locale/tgifglobal_zh_CN.ts \
                src/qt/locale/tgifglobal_zh_TW.ts
