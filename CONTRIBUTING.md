Contributing to TGIFGLOBAL Core
============================

The TGIFGLOBAL Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TGIFGLOBAL Core project, and is not to be
confused with overall TGIFGLOBAL Network Protocol consensus changes.

Whether a pull request is merged into TGIFGLOBAL Core rests with the project merge
...
Patches that change TGIFGLOBAL consensus rules are considerably more involved than
...
Where a patch set proposes to change the TGIFGLOBAL consensus, it must have been
...
The project leader is the release manager for each TGIFGLOBAL Core release.
