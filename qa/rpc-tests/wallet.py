...
#   c) node1 mines 32 blocks, so now node 0 has 60001gif, node 1 has 4250gif, node2 has none.
#   d) node0 sends 601 gif to node2, in two transactions (301 gif, then 300 gif).
