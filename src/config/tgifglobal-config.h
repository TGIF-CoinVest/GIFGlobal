/* src/config/tgifglobal-config.h.  Generated from tgifglobal-config.h.in by configure.  */
/* src/config/tgifglobal-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.tgifglobal.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TGIFGLOBAL Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TGIFGLOBAL Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tgifglobal"
