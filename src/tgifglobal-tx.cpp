...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TGIFGLOBAL Core tgifglobal-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tgifglobal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tgifglobal transaction") + "\n" +
                               "  tgifglobal-tx [options] -create [commands]   " + _("Create hex-encoded tgifglobal transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tgifglobal transaction
