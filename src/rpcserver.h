...
/**
 * TGIFGLOBAL RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzgifseed(const UniValue& params, bool fHelp);
extern UniValue getzgifseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzgif(const UniValue& params, bool fHelp);
extern UniValue dzgifstate(const UniValue& params, bool fHelp);
