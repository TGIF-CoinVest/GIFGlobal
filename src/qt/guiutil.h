...
/** Utility functions used by the TGIFGLOBAL Qt UI.
 */
namespace GUIUtil
{
...
// Render TGIFGLOBAL addresses in monospace font
...
// Parse "tgifglobal:" URI into recipient object, return true on successful parsing
