                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TGIFGLOBAL Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TGIFGLOBAL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tgifglobal: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGIF"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TGIFGLOBAL Core"), this);
    aboutAction->setStatusTip(tr("Show information about TGIFGLOBAL Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TGIFGLOBAL"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TGIFGLOBAL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TGIFGLOBAL addresses"));
    ...
    openAction->setStatusTip(tr("Open a TGIFGLOBAL: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TGIFGLOBAL Core help message to get a list with possible TGIFGLOBAL command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TGIFGLOBAL Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TGIFGLOBAL network", "", count));
}
...
{
    QString strTitle = tr("TGIFGLOBAL Core"); // default title
