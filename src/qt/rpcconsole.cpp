                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGIFPathCustom = GetArg("-zgifbackuppath", "");
    ...
    if(!strzGIFPathCustom.empty()) {
        ui->wallet_customzgifbackuppath->setText(QString::fromStdString(strzGIFPathCustom));
        ui->wallet_customzgifbackuppath_label->setVisible(true);
        ui->wallet_customzgifbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGIFPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TGIFGLOBAL RPC console.") + "<br>" +
