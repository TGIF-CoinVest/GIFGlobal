...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TGIFGLOBAL Core"),
     ...
     * override -datadir in the tgifglobal.conf file in the default data directory
     * (to be consistent with tgifglobald behavior)
     */
    if (dataDir != getDefaultDataDirectory())
