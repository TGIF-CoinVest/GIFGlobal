...
/* TGIFGLOBAL GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TGIFGLOBAL"
#define QAPP_ORG_DOMAIN "tgifglobal.org"
#define QAPP_APP_NAME_DEFAULT "TGIFGLOBAL-Qt"
#define QAPP_APP_NAME_TESTNET "TGIFGLOBAL-Qt-testnet"
