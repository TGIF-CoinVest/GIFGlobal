...
#ifndef TGIFGLOBAL_STAKEINPUT_H
#define TGIFGLOBAL_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZGIF() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zGIFStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zgif, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZGIF() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZGIF() override { return false; }
};


#endif //TGIFGLOBAL_STAKEINPUT_H
