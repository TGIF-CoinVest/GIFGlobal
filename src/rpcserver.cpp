...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop TGIFGLOBAL server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "TGIFGLOBAL server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TGIFGLOBAL features */
        {"tgifglobal", "masternode", &masternode, true, true, false},
        {"tgifglobal", "listmasternodes", &listmasternodes, true, true, false},
        {"tgifglobal", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tgifglobal", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tgifglobal", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"tgifglobal", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"tgifglobal", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"tgifglobal", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tgifglobal", "masternodedebug", &masternodedebug, true, true, false},
        {"tgifglobal", "startmasternode", &startmasternode, true, true, false},
        {"tgifglobal", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tgifglobal", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tgifglobal", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tgifglobal", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tgifglobal", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tgifglobal", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tgifglobal", "mnbudget", &mnbudget, true, true, false},
        {"tgifglobal", "preparebudget", &preparebudget, true, true, false},
        {"tgifglobal", "submitbudget", &submitbudget, true, true, false},
        {"tgifglobal", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tgifglobal", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tgifglobal", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tgifglobal", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tgifglobal", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tgifglobal", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tgifglobal", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tgifglobal", "checkbudgets", &checkbudgets, true, true, false},
        {"tgifglobal", "mnsync", &mnsync, true, true, false},
        {"tgifglobal", "spork", &spork, true, true, false},
        {"tgifglobal", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzgifseed", &getzgifseed, false, false, true},
        {"zerocoin", "setzgifseed", &setzgifseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzgif", &searchdzgif, false, false, true},
        {"zerocoin", "dzgifstate", &dzgifstate, false, false, true}
...
{
    return "> tgifglobal-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7595/\n";
}
