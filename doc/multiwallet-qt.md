...
In order to support loading of multiple wallets in tgifglobal-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tgifglobal.cpp.
...
Changes to tgifglobal.cpp
----------------------
tgifglobal.cpp is the entry point into tgifglobal-qt, and as such, will require some minor modifications to provide hooks for
