...
This mechanism has been integrated into Bitcore-Node-TGIFGLOBAL which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TGIFGLOBAL-Project/insight-api-tgifglobal#web-socket-api](https://github.com/TGIFGLOBAL-Project/insight-api-tgifglobal#web-socket-api) 
* API: [https://github.com/TGIFGLOBAL-Project/insight-api-tgifglobal#swifttx-transactions](https://github.com/TGIFGLOBAL-Project/insight-api-tgifglobal#swifttx-transactions) 
...
By default, the TGIFGLOBAL Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TGIFGLOBAL Core daemon:
